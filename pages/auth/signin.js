...
export default function SignIn({ csrfToken }) {
  ...
  // Récupérer l'erreur de l'URL si elle existe
  const { error: errorFromUrl } = router.query;
  ...
  // Définir l'erreur à partir de l'URL si elle existe
  useState(() => {
    if (errorFromUrl) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <Head>
        <title>Connexion | ConfessX</title>
        <meta name="description" content="Connectez-vous à votre compte ConfessX" />
      ...
      {success && (
        <div className="bg-green-50 border-l-4 border-green-400 p-4 mb-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-green-700">Compte créé avec succès ! Vous pouvez maintenant vous connecter.</p>
            </div>
          </div>
        </div>
      )}
            ...
            >
              {loading ? (
                ...
                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                  <svg className="h-5 w-5 text-primary/80 group-hover:text-primary/60" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
